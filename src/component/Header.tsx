...
const Header = () => {
    ...
    useEffect(() => {
        ...
        if (!session) {
            ...
            localStorage.removeItem('user'); // Completely remove user data from localStorage
            router.replace('/login'); // Uncomment this line to redirect to login if needed
        } else {
            // User is authenticated

            localStorage.setItem('user', JSON.stringify(user)); // Set user data in localStorage on login
        }
    }, [session, status, router]); // Ensure dependencies are correct
                            ...
                            <div className="w-100">
                                <div className="row w-100 align-items-center">
                                    ...
                                    <div className="col-2 border-start border-end d-none d-lg-block">
                                        <div className="d-flex justify-content-center">
                                            <a className="btn btn-outline-primary px-3 py-2 rounded-5 h-auto" href="#">
                                        ...
                                        <div className="position-relative">
                                            <button className="btn header-profile-menu-btn" type="button" id="header-profile-menu-btn" onClick={headerProfileMenuToggle}>
                                                ...
                                                <div className="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <div>
                                                        <p className="mb-0 text-truncate text-start" style={{ fontSize: '14px' }}><strong> {user?.name}</strong></p>
                                                        {/* <Link
                                                                    href="/login"
                                                        ...
                                                        <p className="mb-0 text-secondary text-truncate" style={{ fontSize: '13px' }}>Super admin</p>
                                                    </div>
                                                </div>
                                            </button>
                                            <div className="position-absolute end-0 card header-profile-menu-card shadow mt-3">
                                                <div className="card-header bg-white border-bottom px-2" style={{ '--bs-border-style': 'dashed' } as React.CSSProperties}>
                                                    <div className="d-flex align-items-center bg-gray-1 p-2 rounded-2">
                                                        <div className="me-2">
                                                            <span className="avatar icon rounded-circle shadow">A</span>
                                                        </div>
                                                        <div>
                                                            <p className="mb-0 text-truncate" style={{ fontSize: '14px' }}><strong>{user?.name}</strong></p>
                                                            <p className="mb-0 text-secondary text-truncate" style={{ fontSize: '13px' }}>Super admin</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card-footer bg-white border-top" style={{ '--bs-border-style': 'dashed' } as React.CSSProperties}>
                                                    <ul className="list-unstyled m-0">
                                                        <li>
                                                            <a href="#" className="menu-link">
                                                                <div className="d-flex align-items-center py-2" onClick={() => signOut()}>
...
const Header = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            if (btn) {
                btn.removeEventListener('click', sidebarToggle);
            }
        };
    }, []);
                                ...
                                <div className="row w-100 align-items-center">
                                    <div className="col-5 me-auto d-none d-md-block">
                                        <div className="search-box d-flex align-items-center border rounded-5 overflow-hidden ms-3 bg-gray-1">
                                            ...
                                            <form className="flex-grow-1" action="#">
                                                <input
                                                    className="form-control shadow-none border-0 bg-transparent h-auto"
                                                    type="text"
                                                    placeholder="Search..."
                                                />
                                            </form>
                                    ...
                                    <div className="col-2 d-none d-lg-block">
                                        <div className="d-flex justify-content-center">
                                            <a
                                                className="btn btn-primary px-3 py-2 rounded-5 h-auto"
                                                href="#"
                                            >
                                                Create Shop
                                            </a>
                                    ...
                                    <div className="col-2 border-start border-end d-none d-lg-block">
                                        <div className="d-flex justify-content-center">
                                            <a
                                                className="btn btn-outline-primary px-3 py-2 rounded-5 h-auto"
                                                href="#"
                                            >
                                                Visit Site
                                            </a>
                                    ...
                                    <div className="col-auto col-md-2 ms-auto ms-md-0">
                                        <div className="position-relative">
                                            <button
                                                className="btn header-profile-menu-btn"
                                                type="button"
                                                id="header-profile-menu-btn"
                                                onClick={headerProfileMenuToggle}
                                            >
                                                <div className="d-flex justify-content-center align-items-center">
                                                    <div className="me-2">
                                                        <span className="avatar icon rounded-circle shadow">A</span>
                                                    ...
                                                    <div>
                                                        <p className="mb-0 text-truncate text-start" style={{ fontSize: '14px' }}>
                                                            <strong>John Doe</strong>
                                                        </p>
                                                        <p className="mb-0 text-secondary text-truncate" style={{ fontSize: '13px' }}>
                                                            Super admin
                                                        </p>
                                                    </div>
                                                </div>
