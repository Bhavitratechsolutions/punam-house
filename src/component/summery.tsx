...
const Summery = () => {
    ...
    const [totalServic,setTotalService] = useState(0);
    const [totalProduct,setTotalProduct] = useState(0)
    const [totalEnquiry,setTotalEnquery] = useState(0)
 ...
 const getCompany = async() =>{
    ...
    setTotalCompany(response.data.length)
 }
 ...
 const getEnquiry = async() =>{
    ...
    setTotalEnquery(response.data.length)
 }
        ...
        <>
            ...
            <div className="container">
                <div className="row row-cols-1 g-3 g-md-5">
                    ...
                    <div className="col">
                        <div className="bg-white px-4 py-5 rounded-4">
                            <div className="d-flex justify-content-between mb-5">
                                <h5 className="sec-title position-relative mb-0">Summary</h5>
                            </div>
                            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                <div className="col">
                                <Link href="/admin/company-list" style={{color:'inherit'}}>
                                        ...
                                        <div className="card-body">
                                            <div className="d-flex justify-content-between align-items-center p-2">
                                                ...
                                                <div className="d-flex flex-column text-end">
                                                    <span className="text-secondary">Total Company</span>
                                                    <span className="fs-4 fw-semibold"> {totalCompany}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col">
                                <Link href="/admin/company-service-list" style={{color:'inherit'}}>
                                    <div className="card rounded-3 h-100 dashboard-card" style={{ borderBottomColor: 'rgb(134, 93, 255)' }}>
                                        <div className="card-body">
                                            <div className="d-flex justify-content-between align-items-center p-2">
                                                ...
                                                <div className="d-flex flex-column text-end">
                                                    <span className="text-secondary">Total Service</span>
                                                    <span className="fs-4 fw-semibold">{totalServic}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col">
                                <Link href="/admin/company-product-list" style={{color:'inherit'}}>
                                        ...
                                        <div className="card-body">
                                            <div className="d-flex justify-content-between align-items-center p-2">
                                                ...
                                                <div className="d-flex flex-column text-end">
                                                    ...
                                                    <span className="fs-4 fw-semibold"> {totalProduct}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col">
                                <Link href="/admin/contact-us" style={{color:'inherit'}}>
                                    <div className="card rounded-3 h-100 dashboard-card" style={{ borderBottomColor: 'rgb(225, 87, 160)' }}>
                                        <div className="card-body">
                                            <div className="d-flex justify-content-between align-items-center p-2">
                                                ...
                                                <div className="d-flex flex-column text-end">
                                                    <span className="text-secondary">Total Enquiry </span>
                                                    <span className="fs-4 fw-semibold">   {totalEnquiry} </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
