                        ...
                        <li className="menu__item dropdown ">
                            ...
                            <ul className="dropdown-menu" style={{ background: '#0563a9', width: '100%', textAlign: 'center' }}>
                                {companyList && companyList.map((item, i) => (
                                    <>
                                        <li className="menu__item"><Link className="menu__link" href={`/company/${item.slug}`}>  {item.name.charAt(0).toUpperCase() + item.name.slice(1).toLowerCase()} </Link></li>
                        ...
                        <ul className="navbar-nav ms-auto my-2 my-lg-0">
                            ...
                            <li className="nav-item dropdown ">
                                ...
                                <ul className="dropdown-menu">
                                    {companyList && companyList.map((item, i) => (
                                        <>
                                            <li><Link className="dropdown-item" href={`/company/${item.slug}`}>  {item.name.charAt(0).toUpperCase() + item.name.slice(1).toLowerCase()} </Link></li>
