...
const Edit = () => {
    ...
    const getSingleRecord = async () => {
        try {
            let response = await axios.get(`/api/company-slider/${id}`);
            if (response.data) {
                
                setTitle(response.data.title);
                setCompany(response.data.company);
                setPrevImg(response.data.slider_img);
                setImage(response.data.slider_img);
            }
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.put(`/api/company-slider/${id}`, data);
            ...
            if (!response.data.success) {
                ...
                setTimeout(() => {
                    router.push('/admin/company-slider-list');
                }, 500);
            }
        } catch (error: any) {
