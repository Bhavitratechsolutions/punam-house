...
const ItemList = () => {
    ...
    const handleDelete = async (id: string) => {
        try {
            const response = await axios.delete(`/api/company-slider/${id}`);
    ...
    const filteredDataList = dataList.filter(item =>
        searchItem.toLowerCase() === "" ? item : item.title.toLowerCase().includes(searchItem)
    );
                        ...
                        <div className="bg-white px-4 py-5 rounded-3">
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <h5 className="sec-title position-relative mb-0">
                                    <Link href={'/admin/add-company-slider'} className="btn btn-sm btn-primary" style={{ float: 'right' }}> + Add </Link><br />
                                </h5>
                                <div className="w-50">
                                ...
                                <tbody>
                                    {currentItems.map((item, i) => (
                                        ...
                                        <tr key={item._id}>
                                            ...
                                            <td>
                                                <div>
                                                    <Link href={`/admin/edit-company-slider/${item._id}`}>
