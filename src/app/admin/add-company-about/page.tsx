...
const Add = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.post('/api/company-about', data);
                                                ...
                                                <div className="card-body">
                                                    <div className="row mb-3">
                                                        <div className="col-12">
                                                            ...
                                                            <textarea className="form-control" value={otherDesc} placeholder="Description" rows={5} onChange={(e) => setOtherDesc(e.target.value)} id="comment" name="text"></textarea>
