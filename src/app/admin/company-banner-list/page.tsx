...
const ItemList = () => {
    ...
    const getDataList = async () => {
        try {
            const response = await axios.get('/api/company-banner');
    ...
    const handleDelete = async (id: string) => {
        try {
            const response = await axios.delete(`/api/company-banner/${id}`);
                        ...
                        <div className="bg-white px-4 py-5 rounded-3">
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <h5 className="sec-title position-relative mb-0">
                                    <Link href={'/admin/add-company-banner'} className="btn btn-sm btn-primary" style={{ float: 'right' }}> + Add Banner </Link><br />
                                </h5>
                                <div className="w-50">
                                ...
                                <tbody>
                                    {currentItems.map((item, i) => (
                                        ...
                                        <tr key={item._id}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <Image
                                                        ...
                                                        src={!item.banner_img ? '/images/placeholder.png' : item.banner_img}
                                            ...
                                            <td>
                                                <div>
                                                    <Link href={`/admin/edit-company-banner/${item._id}`}>
