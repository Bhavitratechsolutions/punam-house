                        ...
                        <div className="bg-white px-4 py-5 rounded-3">
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <h5 className="sec-title position-relative mb-0">
                                    <Link href={'/admin/add-about-us'} className="btn btn-sm btn-primary" style={{ float: 'right' }}> + Add AboutUs</Link><br />
                                </h5>
                                <div className="w-50">
                                ...
                                <tbody>
                                    {currentItems.map((item, i) => (
                                        ...
                                        <tr key={item._id}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <Image
                                                        ...
                                                        src={!item.about_img ? '/img/no-image.png'   :  item.about_img}
                                            ...
                                            <td>
                                                <div>
                                                    <Link href={`/admin/edit-about-us/${item._id}`}>
