...
const ItemList = () => {
    ...
    const handleDelete = async (id: string) => {
        try {
            const response = await axios.delete(`api/home-slider/${id}`);
    ...
    const filteredDataList = dataList.filter(item =>
        searchItem.toLowerCase() === "" ? item : item.heading.toLowerCase().includes(searchItem)
    );
                        ...
                        <div className="bg-white px-4 py-5 rounded-3">
                            <div className="d-flex justify-content-between align-items-center mb-5">
                                <h5 className="sec-title position-relative mb-0">
                                    <Link href={'/admin/add-home-slider'} className="btn btn-sm btn-primary" style={{ float: 'right' }}> + Add Home Slider </Link><br />
                                </h5>
                                <div className="w-50">
                                ...
                                <tbody>
                                    {currentItems.map((item, i) => (
                                        ...
                                        <tr key={item._id}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <Image
                                                        ...
                                                        src={!item.slider_img ? '/images/placeholder.png' : item.slider_img}
                                            ...
                                            <td>
                                                <div>
                                                    <Link href={`/admin/edit-home-slider/${item._id}`}>
