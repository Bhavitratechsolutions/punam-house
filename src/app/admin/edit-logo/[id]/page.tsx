...
const Edit = () => {
    ...
    const getSingleRecord = async () => {
        try {
            let response = await axios.get(`/api/logo/${id}`);
            if (response.data) {
                setHeading(response.data.heading);
                setPrevImg(response.data.logo_img);
                setImage(response.data.logo_img);
            }
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.put(`/api/logo/${id}`, data);
    ...
    return (
        <>
            ...
            <div className="container">
                <h5 className="mb-4">Edit Logo </h5>
