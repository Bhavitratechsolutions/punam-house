...
const Edit = () => {
    ...
    const getSingleRecord = async () => {
        try {
            let response = await axios.get(`/api/company-service/${id}`);
            if (response.data) {
                setDescription(response.data.description);
                setServiceName(response.data.serviceName);
                setTitle(response.data.title);
                setCompany(response.data.company);
                setPrevImg(response.data.service_img);
                setImage(response.data.service_img);
            }
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.put(`/api/company-service/${id}`, data);
            ...
            if (!response.data.success) {
                ...
                setTimeout(() => {
                    router.push('/admin/company-service-list');
                }, 500);
            }
        } catch (error: any) {
    ...
    return (
        <>
            ...
            <div className="container">
                <h5 className="mb-4">Edit Company Service </h5>
                                            ...
                                            <div className="card-body">
                                                <div className="row mb-3">
                                                    <div className="col-12">
                                                        ...
                                                        <select className="form-select" name="" id="" value={company} onChange={(e) => setCompany(e.target.value)}>
                                            ...
                                            <div className="card-body">
                                                <div className="row mb-3">
                                                    <div className="col-12">
                                                        ...
                                                        <input className="form-control" type="text" name="" placeholder="Service Name"
                                                            value={serviceName}
