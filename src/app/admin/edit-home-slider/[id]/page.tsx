...
const Edit = () => {
    ...
    const getSingleRecord = async () => {
        try {
            let response = await axios.get(`/api/home-slider/${id}`);
            if (response.data) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            data.set('file', image as File);
        
            data.set('heading', heading);

            const response = await axios.put(`/api/home-slider/${id}`, data);
            ...
            if (!response.data.success) {
                ...
                setTimeout(() => {
                    router.push('/admin/home-slider-list');
                }, 500);
            }
        } catch (error: any) {
