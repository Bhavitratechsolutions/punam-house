...
const Edit = () => {
    ...
    const getSingleRecord = async () => {
        try {
            let response = await axios.get(`/api/company-banner/${id}`);
            if (response.data) {
                setDescription(response.data.description);
                setHeading(response.data.heading);
                setTitle(response.data.title);
                setCompany(response.data.company);
                setPrevImg(response.data.banner_img);
                setImage(response.data.banner_img);
            }
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.put(`/api/company-banner/${id}`, data);
            ...
            if (!response.data.success) {
                ...
                setTimeout(() => {
                    router.push('/admin/company-banner-list');
                }, 500);
            }
        } catch (error: any) {
    ...
    return (
        <>
            ...
            <div className="container">
                <h5 className="mb-4">Add Company Banner </h5>
                                            ...
                                            <div className="card-body">
                                                <div className="row mb-3">
                                                    <div className="col-12">
                                                        ...
                                                        <select className="form-select" name="" id=""  onChange={(e) => setCompany(e.target.value)}>
