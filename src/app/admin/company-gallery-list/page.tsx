...
//         try {
//             const response = await axios.delete(`/api/company-gallery/${id}`);
...
//                                     <Link href={'/admin/add-company-gallery'} className="btn btn-sm btn-primary" style={{ float: 'right' }}> + Add </Link><br />
//                                 </h5>
//                                 <div className="w-50">
...
//                                                         src={!item.gallery_img ? '/images/placeholder.png' : `/images/${item.gallery_img}`}
...
//                                             <td>
//                                                 <div>
//                                                     <Link href={`/admin/edit-company-gallery/${item._id}`}>
                                        ...
                                        <tr key={item._id}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <Image
                                                        className="rounded me-2"
                                                        src={!item.gallery_img ? '/images/placeholder.png' : item.gallery_img}
                                                        alt={"Gallery Image"}
                                                        width={50}
                                                        height={50}
                                                    />
